...
export const PopWindow = (props: PopWindowProps) => {
...
// export const PopWindowInternal = (props: PopWindowProps) => {
//
//     <div>
//         {props.activator(showPopWindow)}
//         {visible && (
//             <div id="modal" className={modalCls}>
